...
async def start(message:types.Message):
    ...
    await message.answer("Бот сможет скачать видео и аудио с ютуба")
    await message.answer("Если незнаете комманды пропишите /help")
...
async def audio(message:types.Message):
    await message.reply("Отправьте ссылку на аудио и бот скачает.")
...
async def download_audio(message:types.Message, state:FSMContext):
    if url_valid(message.text) == True:
        ...
        await state.finish()
            ...
            await message.reply("Отправленная ссылка не верна. Отправьте ссылку на Youtube видео.")
...
async def download_video(message:types.Message, state:FSMContext):
    if url_valid( message.text) == True:
        ...
        await message.reply("Отправленная ссылка на видео. Отправьте ссылку на Youtube видео.")
